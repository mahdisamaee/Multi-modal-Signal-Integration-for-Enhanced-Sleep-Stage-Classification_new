...
train_data_main = np.load("concatenated_train_data_ROC_A1.npy")

Test_data_main = np.load("concatenated_val_data_ROC_A1.npy")
...
train_data_EEG, test_data_EEG, train_labels_EEG, test_labels_EEG = train_test_split(
    train_data_main, train_labels_main, test_size=0.10, random_state=42, shuffle=True)
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv1d(1, 64, kernel_size=50, stride=6, padding=1)
...
print("Saving model ...")
torch.save(model2.state_dict(), "model2_CNN_1D_RAW_EEG_O1_A2_K1.pth")
torch.save(classifier2.state_dict(), "classifier2_CNN_1D_RAW_EEG_O1_A2_K1.pth")

print("Saving features ...")
np.save("ROC_A1_RAW_trainFeatures_K1.npy", features_EEG_final)
np.save("ROC_A1_RAW_testFeatures_K1.npy", features_test_EEG_final)
