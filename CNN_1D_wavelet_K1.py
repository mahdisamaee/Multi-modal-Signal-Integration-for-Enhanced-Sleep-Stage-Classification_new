...
torch.save(model2.state_dict(), "model2_CNN_1D_wavelet_ROC_A1_K1.pth")
torch.save(classifier2.state_dict(), "classifier2_CNN_1D_wavelet_ROC_A1_K1.pth")



print("saving features ...")
np.save("ROC_A1_wavelet_trainFeatures_K1.npy", features_EEG_final)
np.save("ROC_A1_wavelet_testFeatures_K1.npy",features_test_EEG_final)
