...
train_data_main = np.load("concatenated_EEG_C3_A2_train_data_STFT_K1.npy")

test_data_main = np.load("concatenated_EEG_C3_A2_val_data_STFT_K1.npy")
...
#########################
train_data_EEG_Pz_Oz, test_data_EEG_Pz_Oz, train_labels_EEG_Pz_Oz, test_labels_EEG_Pz_Oz = train_test_split(train_data_main, train_labels_main, test_size=0.20, random_state=42, shuffle=True)
...
class MLPClassifier2(nn.Module):
    def __init__(self, num_classes):
        ...
        self.relu1 = nn.ReLU()
        self.fc = nn.Linear(128, num_classes)  # 100 features from the CNN
...
torch.save(model2.state_dict(), "model2_CNN_2D_STFT_EEG_C3_A2_K1.pth")
torch.save(classifier2.state_dict(), "classifier2_CNN_2D_STFT_EEG_C3_A2_K1.pth")


print("saving features ...")
np.save("EEG_C3_A2_STFT_trainFeatures_K1_CNN2D.npy", features_EEG_Pz_Oz_final)
np.save("EEG_C3_A2_STFT_testFeatures_K1_CNN2D.npy",features_test_EEG_Pz_Oz_final)