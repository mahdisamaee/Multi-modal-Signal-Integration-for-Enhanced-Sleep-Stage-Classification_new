...
rf_classifier.fit(train_features_final, train_labels)

# Predict classes on the test data
predictions = rf_classifier.predict(test_features_final)
...
# Calculating precision, recall, F1-score, and Macro F1-score
...
plt.savefig("ConfusionMatrix_AllFeatures_RF.png")
plt.show()
